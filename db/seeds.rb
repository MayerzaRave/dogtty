...
user.photo.attach(io: URI.open(IMAGES[0]), filename: "nes.png", content_type: "image/png")
...
pet.photo.attach(io: URI.open(PETS[0]), filename: "nes.png", content_type: "image/png")
pet.save
